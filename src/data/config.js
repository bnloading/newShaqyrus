...
export const GUEST_COMMENTS = {
  kz: [
    {
      name: "Айару",
      message: "Бұл шақырудың әр деталі сондай нәзік әрі әсем көрінеді. Күні келгенше асыға күтеміз.",
    },
    {
      name: "Нұрасыл",
      message: "Видео мен атмосфера керемет үйлескен. Мерекелеріңіз махаббат пен жылылыққа толы болсын.",
    },
    {
      name: "Мөлдір",
      message: "Шақырудың стилі өте есте қаларлық. Сіздердің қуаныштарыңызбен бірге болу біз үшін үлкен мәртебе.",
    },
  ],
  mn: [
    {
      name: "Аяа",
      message: "Урилгын уур амьсгал маш тансаг харагдаж байна. Тэр өдрийг тэсэн ядан хүлээж байна.",
    },
    {
      name: "Насан",
      message: "Видео болон дизайн нь үнэхээр гоёмсог зохицжээ. Та хоёрын баяр хайраар дүүрэн байх болтугай.",
    },
    {
      name: "Солонго",
      message: "Энэ урилга маш дурсамжтай, сэтгэлд дулаахан санагдлаа. Баярт тань хамт байхад баяртай байна.",
    },
  ],
};
